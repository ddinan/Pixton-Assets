   ...
   public class GIFDecoder
   {
      ...
      private function getPixels(param1:BitmapData) : Array
      {
         ...
         while(_loc7_ < _loc5_)
         {
            ...
            while(_loc8_ < _loc4_)
            {
               _loc6_ = param1.getPixel(_loc7_,_loc8_);
               var _loc9_:*;
      ...
      private function transferPixels() : void
      {
         ...
         if(this.lastDispose > 0)
         {
            ...
            if(this.lastImage != null)
            {
               ...
               {
                  _loc8_ = !!this.transparency ? Number(0) : Number(this.lastBgColor);
      ...
      private function decodeImageData() : void
      {
         ...
         _loc14_ = int(_loc10_ = _loc12_ = _loc16_ = int(_loc17_ = _loc19_ = _loc18_ = 0));
         _loc13_ = 0;
      ...
      private function readImage() : void
      {
         ...
         {
            _loc2_ = this.act[this.transIndex];
